...
const questionsList = [
    ...
    {
        id: 4,
        title: 'Apakah Anda pernah mencoba diet? Apakah Anda mendapat hasil yang diharapkan?',
        answers: [
            { id: 0, title: 'Ya, saya berhasil menurunkan berat badan, berat badan tidak kembali', point: 1 },
    ...
    },
    {
        ...
        answers: [
            { id: 0, title: 'Saya jarang minum, hanya teh, kopi, soda, dll', point: 4 },
    ...
    {
        id: 10,
        title: 'Telah terbukti bahwa menurunkan berat badan, hanya mengandalkan kemungkinan olahraga dan diet, tidak sepenuhnya efektif. Bagaimana perasaan Anda tentang berbagai suplemen yang membantu Anda mendapatkan bentuk tubuh impian Anda?',
        answers: [
            { id: 0, title: 'Tidak pernah mencoba', point: 3, isUsed: 'false' },
            { id: 1, title: 'Mencoba (a) beberapa, tidak membantu (atau bobot naik kembali)', point: 2, isUsed: 'true' },
            { id: 2, title: 'Pernah mencoba, berhasil membantu', point: 1, isUsed: 'true' },
        ]
    },
];
...
const individualText = [
    {
        id: 1,
        individualMessage: 'Terima kasih telah meminta bantuan dalam menyusun rencana penurunan berat badan yang individual. Saya senang melihat bahwa Anda sudah aktif berolahraga dan tertarik pada pola makan yang sehat. Untuk mendukung proses penurunan berat badan Anda dan mencapai hasil yang diinginkan, saya telah menyusun rencana individual yang mencakup penggunaan suplemen tambahan biologis untuk menjaga proses penurunan berat badan dan stabilisasi berat badan.',
        items: [
            'Membantu penurunan berat badan dengan cepat dan efektif.',
            'Mereka mengurangi nafsu makan',
            'Mereka meningkatkan metabolisme',
        ],
        message: 'Selain itu, formula ini mengandung kompleks bahan-bahan yang membantu meningkatkan proses metabolisme dalam tubuh dan meningkatkan tingkat energi. Anda akan merasa lebih segar dan berenergi sepanjang hari.',
    },
    {
        id: 2,
        individualMessage: 'Terima kasih telah meminta bantuan dalam menyusun rencana penurunan berat badan yang individual. Mengingat pengalaman Anda dengan efek yo-yo, latihan fisik yang periodik, dan keinginan untuk menerapkan pola makan yang sehat, saya telah menyusun rencana yang mencakup penggunaan suplemen tambahan biologis untuk mendukung proses penurunan berat badan dan stabilisasi berat badan.',
        items: [
            'Membantu penurunan berat badan dengan cepat dan efektif',
            'Mereka mengurangi nafsu makan',
            'Mereka meningkatkan metabolisme',
    ...
    {
        id: 3,
        individualMessage: 'Terima kasih telah meminta bantuan dalam menyusun rencana penurunan berat badan yang individual. Mengingat pengalaman Anda dengan diet, tantangan dalam mengendalikan diri, dan keinginan untuk memulai aktivitas olahraga, saya telah menyusun rencana yang mencakup penggunaan suplemen tambahan biologis untuk mendukung proses penurunan berat badan.',
        items: [
            'Membantu penurunan berat badan dengan cepat dan efektif',
            'Mereka mengurangi nafsu makan',
            'Mereka meningkatkan metabolisme',
    ...
    {
        id: 4,
        individualMessage: 'Dengan mempertimbangkan preferensi dan keinginan Anda untuk menurunkan berat badan tanpa mengubah gaya hidup utama, saya telah menyusun rencana yang mencakup penggunaan suplemen tambahan biologis untuk membantu Anda mencapai tujuan yang ditetapkan tanpa mengubah gaya hidup.',
        items: [
        ...
        message: 'SlimMax ini cocok untuk mereka yang memiliki gaya hidup yang kurang aktif dan tidak memiliki kesempatan untuk makan dengan benar.',
    },
];
